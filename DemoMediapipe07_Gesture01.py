...
findHands=mpHands(maxHands=1,tol1=.5,tol2=.5)
...
while True:
    ...
    if train==True:
        if handData!=[]:
            print('Please Show Gesture ',gestNames[trainCnt],': Press n when Ready')
    ...
    if train == False:
        if handData!=[]:
            ...
            cv2.putText(frame,myGesture,(100,175),cv2.FONT_HERSHEY_SIMPLEX,3,(0,255,0),8)
